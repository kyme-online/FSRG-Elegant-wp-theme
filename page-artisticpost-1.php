...
<?php Starkers_Utilities::get_template_parts( array( 'parts/shared/html-header', 'parts/shared/header' ) ); ?>
				...
				<div id="content-post">
									...
									<div id="contentpost-img">                                           
										<img alt="artwork gallery" alt="artwork gallery" src="<?php echo get_template_directory_uri().'/images/artistic/1.jpg'; ?>" />							
