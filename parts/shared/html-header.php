										...
										<div id="m1" class="submenu">
											 <span class="submenu-wrap">
											 	<span class="submenu-content">
											 		<span class="submenu-item bgsubmenu"><img class="imagesubmenu" src="<?php echo get_template_directory_uri().'/images/livingroom-subpage.png'; ?>" /><a href="/livingroom/" class="alignmentbtn1"><div class="linktext-menu">LIVING ROOM</div></a></span>
											 		<span class="submenu-item"><img class="imagesubmenu" src="<?php echo get_template_directory_uri().'/images/accentfurniture-subpage.png'; ?>" /><a href="/accentfurniture/" class="alignmentbtn2"><div class="linktext-menu">ACCENT FURNITURE</div></a></span>
											 	</span>
											 </span>
										</div>
									</li>
										...
										<div id="m2" class="submenu">
											 <span class="submenu-wrap">
												<span class="submenu-content">
													...
													<span class="submenu-item "><img class="imagesubmenu" src="<?php echo get_template_directory_uri().'/images/mirror-subpage.png'; ?>" /><a href="/mirror/" class="alignmentbtn6"><div class="linktext-menu">MIRROR</div></a></span>
												</span>
											</span>
										</div>
									</li>
										...
										<div id="m3" class="submenu">
											<span class="submenu-wrap">
												<span class="submenu-content">
													...
													<span class="submenu-item"><img class="imagesubmenu" src="<?php echo get_template_directory_uri().'/images/historical-subpage.png'; ?>" /><a href="/historical/" class="alignmentbtn8"><div class="linktext-menu">HISTORICAL</div></a></span>
												</span>
											</span>
										</div>
									</li>
